...
namespace SportsStoreEF.Migrations
{
    ...
    [Migration("20190226073342_Customer")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportsStoreEF.Models.Order", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SportsStoreEF.Models.OrderLine", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SportsStoreEF.Models.OrderLine", b =>
                {
                    b.HasOne("SportsStoreEF.Models.Order", "Order")
                        .WithMany("Lines")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("SportsStoreEF.Models.Product", "Product")
                        .WithMany()
